...
void PlaylistGeneratorInserter::Load(Playlist* destination, int row, bool play_now, bool enqueue, bool enqueue_next, PlaylistGeneratorPtr generator, int dynamic_count) {
