...
PlaylistQueryGenerator::PlaylistQueryGenerator(const QString &name, const SmartPlaylistSearch &search, bool dynamic)
...
PlaylistItemList PlaylistQueryGenerator::GenerateMore(int count) {
  ...
  for (const Song &song : songs) {
    items << PlaylistItemPtr(PlaylistItem::NewFromSongsTable(backend_->songs_table(), song));
