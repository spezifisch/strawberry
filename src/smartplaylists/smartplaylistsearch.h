...
class SmartPlaylistSearch {
 ...
 public:
  ...
  SmartPlaylistSearch();
  SmartPlaylistSearch(SearchType type, TermList terms, SortType sort_type, SmartPlaylistSearchTerm::Field sort_field, int limit = PlaylistGenerator::kDefaultLimit);
