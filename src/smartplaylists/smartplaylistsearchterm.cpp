  ...
  switch (operator_) {
    ...
    case Op_Equals:
      if (TypeOf(field_) == Type_Text)
        return col + " LIKE '" + value + "'";
      else if (TypeOf(field_) == Type_Date || TypeOf(field_) == Type_Time)
        return col + " = " + value;
      else
        return col + " = '" + value + "'";
    case Op_GreaterThan:
      if (TypeOf(field_) == Type_Date || TypeOf(field_) == Type_Time)
        return col + " > " + value;
      else
        return col + " > '" + value + "'";
    case Op_LessThan:
...
QString SmartPlaylistSearchTerm::DateName(DateType date, bool forQuery) {
