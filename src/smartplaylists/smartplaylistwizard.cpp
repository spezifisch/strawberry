...
SmartPlaylistWizard::SmartPlaylistWizard(Application *app, CollectionBackend *collection, QWidget *parent)
  ...
  type_page_->setSubTitle(
      tr("A smart playlist is a dynamic list of songs that come from your collection.  There are different types of smart playlist that offer different ways of selecting songs."));
...
void SmartPlaylistWizard::TypeChanged(int index) {
...
void SmartPlaylistWizard::initializePage(int id) {
